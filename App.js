...
const CONTRACT_ADDRESS = "0xE8Ba230170183D16ca83eD669B218aE9F4dEB1D2";
...
function App() {
  ...
  const deletePoll = async (pollId) => {
    try {
      ...
      alert("Failed to delete poll. Make sure you're the creator.");
    }
  };
                  ...
                  {polls.map(poll => (
                    <div key={poll.id} className="poll-card">
                      ...
                      {poll.creator.toLowerCase() === account.toLowerCase() && (
                         <div className="created-by-you-tag">
                      ...
                      {poll.creator.toLowerCase() === account.toLowerCase() && (
                             <button onClick={() => deletePoll(poll.id)} className="delete-btn">
                              Delete Poll
                              </button>
                            )}
